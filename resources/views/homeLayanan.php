...
<head>
    ...
    <title>Kouvee Pet Shop - Layanan CRUD</title>
    <style>
...
<body>
    <nav class="navbar">
        <div class="nav-container">
            ...
            <ul class="nav-links">
                ...
                <li><a href="#" class="active" onclick="showPage('services')">💼 Layanan (CRUD)</a></li>
    ...
    <div id="services-page" class="products-section">
        <div class="container">
            <h1 class="section-title">Kelola Layanan Kouvee Pet Shop</h1>
            ...
            <div class="search-bar">
                ...
                <div class="sort-wrapper">
                    <button class="btn btn-primary" onclick="openServiceModal()">➕ Tambah Layanan Baru</button>
                </div>
                <div class="sort-wrapper">
                    <span>↕️ Sortir: </span>
    ...
    <div id="serviceModal" class="modal hidden">
        <div class="modal-content">
            <h2 id="modalTitle">Tambah Layanan Baru</h2>
            <form id="serviceForm">
                ...
                <div class="form-group">
                    <label for="serviceDuration">Perkiraan Durasi (Menit)</label>
                    <input type="number" id="serviceDuration" required min="5">
                </div>

                <div class="form-group">
                    <label for="serviceDescription">Deskripsi Singkat</label>
